...
module.exports = {
  content: [
    "./*.{html,js}", 
    "./{assets,assets_gudang,functions,media,icons}/**/*.{html,js}"
  ],
  safelist: [
    // Safelist penting untuk kelas dinamis (JS)
    {
      pattern: /(bg|text|border)-(red|green|blue|emerald|slate|amber|cyan|indigo)-(50|100|200|300|400|500|600|700|800|900|950)/,
      variants: ['hover', 'focus', 'active', 'dark'],
    },
    // Safelist specific custom colors/fonts if dynamically called
    'font-arab', 'font-arabic',
